    ...
    <div class="card-separate">
      <div class="skinview card">
        ...
        <div class="asset-management" v-if="owner">
          <SkinUploadModal
            @uploaded="authStore.updateAsset('skin', $event)"
          ></SkinUploadModal>
          <CapeUploadModal
            @uploaded="authStore.updateAsset('cape', $event)"
          ></CapeUploadModal>
        </div>
      </div>
      <div>
        <div>
          ...
          <div v-for="p in playerinfo.filter((x) => x.value)">
            <span class="playerinfo-name">{{ p.name }}:</span>
        ...
        <!-- <div v-if="balance">
          ...
          <div v-for="p in balance">
            <span class="playerinfo-value">{{ p.balance }}</span>
            <span class="playerinfo-name">{{ p.currency }}</span>
          </div>
        </div> -->
